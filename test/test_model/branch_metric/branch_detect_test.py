...
class BranchDetectTest(unittest.TestCase):
    def test_branch1(self):
        ...
        branch_result = branch_leaf_metric(test_swc_tree=gold_swc_tree, gold_swc_tree=test_swc_tree, config=config)
    ...
    def test_branch7(self):
        ...
        branch_result = branch_leaf_metric(test_swc_tree=test_swc_tree,
